            ...
            <div>
                {
                    this.state.news.map((item,index)=>{
                        return <div className="mdl-card mdl-shadow--2dp" key={index} style={{width:'100%'}}>
                                        <div className="mdl-card__title">
                                            <h2 className="mdl-card__title-text"><a target="_blank" href={item[1]}>{item[0]}</a></h2>
                                        </div>
